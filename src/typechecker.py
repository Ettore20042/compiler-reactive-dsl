...
Esegue il type checking: verificare compatibilità di tipi, cast impliciti, coercion.
"""
from .ast_nodes import *

class TypeChecker:
    """Visitor che verifica la compatibilità dei tipi su tutto l'AST."""

    def __init__(self, scope_analyzer):
        """scope_analyzer contiene già la symbol_table e le funzioni."""
    ...
    def _check_function_call(self, func_name, args):
        """Verifica la compatibilità dei tipi degli argomenti."""
